...
import { Box, Button, Text, Heading, VStack, Container } from '@chakra-ui/react';
            ...
            <VStack gap={8} align="stretch">
                ...
                <Box p={6} borderWidth={1} borderRadius="lg" boxShadow="md" bg="white">
                    <VStack gap={4}>
                        <Text fontSize="lg">
                            Status:
                            <Text as="span" ml={2} color={isConnected ? 'green.500' : 'red.500'} fontWeight="bold">
                        ...
                        {pongMessage && (
                            <Box p={4} mt={4} bg="gray.50" borderRadius="md" w="100%">
                                <Text fontWeight="bold" mb={2}>Server Response:</Text>
